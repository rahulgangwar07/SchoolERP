...
- Create Angular project with ng: `ng new schoolerpsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`schoolerpsystem.client.esproj`).
